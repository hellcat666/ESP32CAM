 ...
 */
public class ESP32CameraActivity extends AppCompatActivity implements ESP32CameraFragment.OnESP32CameraFragmentInterface {
    ...
    private OV2640Camera mOV2640Camera1;
...
//            checkCommunication();
    ...
    private void initCamera() {
        mOV2640Camera1 = new OV2640Camera("Camera #2", "192.168.1.12");
    }
    ...
    private void registerReceiver() {
        ...
        mAppFilter.addAction(CAMERA_STATUS);
